...
//  DBGVV("msgUnpackHeader: sourceCommunicationTechnology %d\n", header->sourceCommunicationTechnology);
  ...
  header->sourcePortId = *(UInteger16*)(buf + PTPV2_SRC_PORT_ID_OFFSET);
  header->sequenceId = *(UInteger16*)(buf + PTPV2_SEQUENCE_ID_OFFSET);
...
//  DBGVV("msgUnpackSync: grandmasterCommunicationTechnology %d\n", sync->grandmasterCommunicationTechnology);
  ...
  sync->grandmasterPortId = *(UInteger16*)(buf + PTPV2_SRC_PORT_ID_OFFSET);
  DBGVV("msgUnpackSync: grandmasterPortId %d\n", sync->grandmasterPortId);
  sync->grandmasterSequenceId = *(UInteger16*)(buf + PTPV2_SEQUENCE_ID_OFFSET);
...
//  DBGVV("msgUnpackDelayResp: requestingSourceCommunicationTechnology %d\n", resp->requestingSourceCommunicationTechnology);
  ...
  resp->requestingSourcePortId = *(UInteger16*)(buf + PTPV2_SRC_PORT_ID_OFFSET);
  DBGVV("msgUnpackDelayResp: requestingSourcePortId %d\n", resp->requestingSourcePortId);
  resp->requestingSourceSequenceId = *(UInteger16*)(buf + PTPV2_SEQUENCE_ID_OFFSET);
...
//  msgPackHeader(buf, ptpClock);
  ...
  *(buf + PTPV2_MESSAGE_LENGTH_OFFSET) = PTPV2_SYNC_LENGTH;
  memcpy((buf + PTPV2_CLOCK_ID_OFFSET), ptpClock->clock_uuid_field, PTPV2_CLOCK_ID_LENGTH);
  *(Integer16*)(buf + PTPV2_SRC_PORT_ID_OFFSET) = ptpClock->port_id_field;
  *(Integer16*)(buf + PTPV2_SEQUENCE_ID_OFFSET) = ptpClock->last_sync_event_sequence_number;
...
//  msgPackHeader(buf, ptpClock);
  ...
  *(buf + PTPV2_MESSAGE_LENGTH_OFFSET) = PTPV2_SYNC_LENGTH;
  memcpy((buf + PTPV2_CLOCK_ID_OFFSET), ptpClock->clock_uuid_field, PTPV2_CLOCK_ID_LENGTH);
  *(Integer16*)(buf + PTPV2_SRC_PORT_ID_OFFSET) = ptpClock->port_id_field;
  *(Integer16*)(buf + PTPV2_SEQUENCE_ID_OFFSET) = ptpClock->last_general_event_sequence_number;
  *(UInteger8*)(buf + PTPV2_CONTROL_OFFSET) = PTP_FOLLOWUP_MESSAGE;  /* control */
  clearFlag((buf + PTPV2_FLAG_OFFSET), PTP_SYNC_BURST);
  clearFlag((buf + PTPV2_FLAG_OFFSET), PARENT_STATS);
  
  *(Integer16*)(buf + PTPV2_SEQUENCE_ID_OFFSET) = associatedSequenceId;
